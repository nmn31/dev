...
<?php }
 ...
 <div class="row">
  ...
  <div class="col-sm-6"><form role="form"method="post" action="<?php echo "https://".$_SERVER['SERVER_NAME']; ?>/controller/Register.php">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="email" name = "email" onkeypress="return noenter()">
  </div>
